...
const Home = () => {
  const contactInfo = [
    ...
    { icon: "uil uil-whatsapp", title: "Whatsapp", subtitle: "(+250) 781403300" },
    { icon: "uil uil-envelope-edit", title: "Email", subtitle: "ericngabombaraga24@gmail.com" }
  ];
  ...
  return (
    <section id="home" className="home min-h-screen relative">
      <div
        ...
        style={{ backgroundImage: "url('https://i.postimg.cc/hvzrjrC6/portfolio-bg.png')" }}
      ></div>

      <div className="home-container container h-full relative pl-10 py-20">
        {/* Social Links */}
        <div className="home-social absolute top-10  flex items-center gap-14">
          <span className="home-social-follow text-sm font-medium text-title relative pr-5 text-gray-100">
            Follow Me  
            <span className="absolute w-5 h-0.5 -right-7 top-1/2 transform -translate-y-1/2 bg-gray-100"></span>
          </span>
          <div className="home-social-links flex gap-4">
            <a href="https://www.facebook.com" target="_blank" className="home-social-link text-text hover:translate-y-0.5 transition-transform">
              <UilGithub size="20" color="#ffffffb7"/>
            </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          ...
          <div className="home-img justify-center order-1 hidden lg:order-2">
            <img
        ...
        <div className="my-info absolute py-5 pl-0 hidden lg:flex gap-7">
